...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.external_url'
        db.add_column('filer_file', 'external_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.external_url'
        db.delete_column('filer_file', 'external_url')
    ...
    models = {
        ...
        'filer.file': {
            ...
            'external_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
